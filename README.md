...
buscador-cep/ │ ├─ templates/ │ └─ index.html # Template HTML principal │ ├─ static/ │ └─ style.css # Estilos CSS │ ├─ app.py # Código principal em Python ├─ requirements.txt # Dependências do projeto └─ README.md # Este arquivo
...
Bacharelado em Sistemas de Informação | Suporte em TI | Python | Flask | JavaScript | HTML/CSS GitHub: https://github.com/Liviacorreiasilva/Projetos-Front-end-Back-end-e-API
